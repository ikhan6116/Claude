...
export default function HomePage() {
  return (
    <>
      <NextSeo
        title="BrightPath Finance – Business HELOC | Fund Your Business with Home Equity"
        description="Access up to $750,000 for your business with a Figure-powered HELOC. Rates from 6.75% APR. No appraisal. No title fees. Fund in as few as 5 days. NMLS #2670114."
        canonical="https://heloc.brightpath-fin.com"
        openGraph={{
          title: 'BrightPath Finance – Business HELOC | Fund Your Business with Home Equity',
          description: 'Access up to $750,000 for your small business. Rates from 6.75% APR. Powered by Figure. NMLS #2670114.',
        ...
        <section className="bg-brand-blue py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-blue-100 text-xl mb-10 max-w-2xl mx-auto">
              Business owners across the country are using their home equity to grow — at rates
              far below business credit cards. Check your rate in 5 minutes with no credit impact.
            </p>
